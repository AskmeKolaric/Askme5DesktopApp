...
public class VuEventRecord {
	...
	public VuEventRecord(byte[] bytes) throws UnsupportedEncodingException {
		...
		this.eventBeginTime= RealTime.getRealTime(Arrays.copyOfRange(bytes, start, start+=VuSizes.EVENTBEGINTIME.getSize()));
		this.eventEndTime=RealTime.getRealTime(Arrays.copyOfRange(bytes, start, start+=VuSizes.EVENTENDTIME.getSize()));
		this.cardNumberDriverSlotBegin=new FullCardNumber(Arrays.copyOfRange(bytes,start, start+=VuSizes.CARDNUMBERDRIVERSLOTBEGIN_EVENT.getSize()));
		this.cardNumberCoDriverSlotBegin=new FullCardNumber(Arrays.copyOfRange(bytes,start, start+=VuSizes.CARDNUMBERCODRIVERSLOTBEGIN_EVENT.getSize()));
		this.cardNumberDriverSlotEnd=new FullCardNumber(Arrays.copyOfRange(bytes,start, start+=VuSizes.CARDNUMBERDRIVERSLOTEND_EVENT.getSize()));
		this.cardNumberCoDriverSlotEnd=new FullCardNumber(Arrays.copyOfRange(bytes,start, start+=VuSizes.CARDNUMBERCODRIVERSLOTEND_EVENT.getSize()));
