...
/**
 * 2.67. ManufacturerCode C�digo que identifica a un fabricante.
 * ManufacturerCode ::= INTEGER(0..255) Asignaci�n de valor: �00�H No hay
 * informaci�n disponible �01�H Valor reservado �02�H .. �0F�H Reservado para
...
public class ManufacturerCode {
	...
	/**
	 * Obtiene el fabricante de tac�grafo.
	...
	public String getManufactureCode() {
		...
		case 0x32:
			return "EFKON AG.";
		case 0x38:
			return "F�brica Nacional de Moneda y Timbre";
		case 0x40:
		...
		case 0x89:
			return "Polska Wytw�rnia Papier�w Wartosciowych S.A. - PWPW S.A.";
		case 0xA1:
			return String.format("%s (formerly %s)",
