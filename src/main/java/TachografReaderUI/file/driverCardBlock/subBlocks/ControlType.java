 ...
 * 2.44. ControlType
 * 
 * C�digo que indica las actividades realizadas durante un control. Este tipo de datos est� relacionado con los requisitos 102, 210 y 225.
 * 
 * ControlType::= OCTET STRING (SIZE(1))
 *
 * Asignaci�n de valor - Alineaci�n de octeto: 'cvpdxxxx'B (8 bits)
 *
