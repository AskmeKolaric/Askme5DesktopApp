...
//    private static ProgressIndicator bar;
//
//    public static void ReadTachoCard() throws Exception {
//
//
...
//    }
//
//    private static void saveFileAddLastDownload(CardChannel channel, ByteArrayOutputStream output, ResponseAPDU r, long time, OutputStream stream) {
...
//    }
//
//    private static byte[] getTimestampBytes(long time) {
...
//    }
//
//    private static byte[] readSelectedFileOnce(CardChannel channel, int lengthInt) throws Exception {
//        ResponseAPDU rspLen;
//        int p1 = 0x00;
//        int p2 = 0x00;
...
//    }
//
//    private static byte[] readSelectedFile(CardChannel channel, int lengthInt) throws Exception {
//
//        ResponseAPDU rspLen;
//        int restLength;
//        boolean end = true;
